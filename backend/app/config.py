...
VIDEO_TRACK_IOU_THRESH = float(os.environ.get("VIDEO_TRACK_IOU_THRESH", "0.3"))
VIDEO_TRACK_MAX_AGE = int(os.environ.get("VIDEO_TRACK_MAX_AGE", "30"))
VIDEO_TRACK_MIN_HITS = int(os.environ.get("VIDEO_TRACK_MIN_HITS", "3"))
VIDEO_CONF = float(os.environ.get("VIDEO_CONF", "0.25"))
